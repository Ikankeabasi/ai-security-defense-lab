...
def render_level3(user, supabase_client):
    ...
    tab1, tab2, tab3 = st.tabs(["api_config.py [Evidence — Do Not Delete]"
, "requirements_hardened.txt", "api_config_hardened.py"])
    ...
    with tab3:
        ...
        st.code(
            ...
            '# CartBot AI — E-Commerce Platform\n'
            '# SECURITY PATCH — Patched by: Ikanke Asuquo — 31/08/2026\n'
